...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-bg-dark text-white flex items-center justify-center p-4">
            {/* Background Effects */}
            <div className="absolute top-1/4 right-1/3 w-150 h-150 bg-orange-500/10 blur-[150px] rounded-full pointer-events-none" />
            <div className="absolute bottom-1/4 left-1/3 w-125 h-125 bg-amber-500/10 blur-[120px] rounded-full pointer-events-none" />
            ...
            >
                ...
                <div className="bg-bg-card border border-border-dark rounded-2xl p-8 shadow-2xl">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-400">Bienvenue sur LogicAI</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link to="/reset-password" className="text-sm text-brand-blue hover:text-brand-hover transition-colors">
                                Mot de passe oublié ?
                            </Link>
                        </div>
                    ...
                    <p className="text-center text-sm text-gray-400 mt-6">
                        ...
                        <Link to="/register" className="text-brand-blue hover:text-brand-hover transition-colors font-semibold">
                            Créer un compte
                        </Link>
                    </p>
                </div>
